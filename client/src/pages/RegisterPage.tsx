        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <button
            ...
            style={{
              width: '100%',
              padding: '16px 0',
              background: registerMutation.isPending ? '#333' : '#c41e3a',
            ...
            onMouseEnter={e => {
              if (!registerMutation.isPending) e.currentTarget.style.background = '#a01830'
            }}
            onMouseLeave={e => {
              if (!registerMutation.isPending) e.currentTarget.style.background = '#c41e3a'
            }}
          >
